...
// Paths to data files
const ARTISTS_FILE = path_1.default.join(__dirname, '../src/data/artists.ts');
const RELEASES_FILE = path_1.default.join(__dirname, '../src/data/releases.ts');
// Parse artists.ts file to extract artistsData array
function parseArtistsFile() {
    const content = fs_1.default.readFileSync(ARTISTS_FILE, 'utf-8');
...
function parseReleasesFile() {
    const content = fs_1.default.readFileSync(RELEASES_FILE, 'utf-8');
...
`;
    fs_1.default.writeFileSync(ARTISTS_FILE, fileContent, 'utf-8');
}
...
`;
    fs_1.default.writeFileSync(RELEASES_FILE, fileContent, 'utf-8');
}
